package com.lofi.learning.api.unittests.services;
...
import com.lofi.learning.api.unittests.mock.MockBook;
...
class BookServicesTest {
	...
	void testFindById() {
		...
		assertTrue(result.toString().contains("links: [</v1/api/book/1>;rel=\"self\"]"));
	...
	void testFindAll() {
		...
		assertTrue(bookOne.toString().contains("links: [</v1/api/book/1>;rel=\"self\"]"));
		...
		assertTrue(bookFour.toString().contains("links: [</v1/api/book/4>;rel=\"self\"]"));
		...
		assertTrue(bookSeven.toString().contains("links: [</v1/api/book/7>;rel=\"self\"]"));
